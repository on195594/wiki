...
created: 2026-05-29
type: raw_article
tags: [agent, skills, workflow, governance, ai-coding]
source_url: https://www.oreilly.com/radar/agent-skills/
canonical_url: https://addyosmani.com/blog/agent-skills/
author: Addy Osmani
status: captured
---

Title: Agent Skills
Source URL: https://www.oreilly.com/radar/agent-skills/
Canonical URL: https://addyosmani.com/blog/agent-skills/
Author: Addy Osmani
Date: O'Reilly repost May 27, 2026; canonical blog May 3, 2026
Extraction note: O'Reilly page was HTTP 403 from direct fetch; extracted full readable article body from the canonical Addy Osmani source referenced by O'Reilly/search results.
Source quality: full canonical article body extracted from <article id/post-body>.
