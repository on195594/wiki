...
## Summary
这页定义 LifeOS 中个人财务与教育基金层的目标、账户分工、边界和决策原则。它处理的不是“下一笔买什么”，而是：家庭资金系统如何同时服务安全、成长和教育目标，尤其是如何把孩子教育基金从日常情绪与随意挪用中隔离出来，形成一个中期稳健、目标导向的资金模型。

## Core objective
当前财务系统至少承担三件事：
- 保障家庭安全垫与流动性
- 服务中长期资产增值
- 为孩子教育目标提供单独、可持续、不过度冒险的资金支持

## Education fund objective
当前已知目标是：
- 金额基线：10 万元
- 时间跨度：约 6 年，小学毕业前尽量不动用
- 风格偏好：中期稳健增值，优先服务教育目标，而不是追求高波动收益

这意味着教育基金不是“可以顺手拿来补别的洞”的普通现金池，而是目标锁定资金。
...
6 年期目标可以承受一定波动，但不能使用高度依赖时点运气的高波动方案。
